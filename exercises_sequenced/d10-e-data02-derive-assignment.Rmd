...
```
The commented version computes a summary over the entire dataframe, while the uncommented version computes summaries over groups of color and clarity.
...
cov_diff is enormous!

- Why is `cov_diff` so large?
The mean difference between depth and depth_computed is small, which causes the cov to blow up.

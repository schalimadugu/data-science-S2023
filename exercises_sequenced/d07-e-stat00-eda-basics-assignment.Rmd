...
Ideal cut diamonds are actually more numerous than all other cuts! This might be because cutting a diamond is easier than mining a new one, so gemcutters add value to a diamond by striving for an ideal cut.
...
**Observations**:
- Write your observations here!
Inneffective - we cannot address Hypothesis 2 with this graph.
...
**Observations**:
- Write your observations here!
Surprisingly, ideal diamonds tend to be the least pricey!
...
**Observations**:
- Write your observations here!
The median ideal diamonds is a bit lower in carat than other cuts, which shows that gemcutters trade cut for carat. Ideal diamonds might be cheaper since they are likely to be lower-carat.

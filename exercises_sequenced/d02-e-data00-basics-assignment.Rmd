...
summary(diamonds)
```
carat: mean 0.7979, variation 4.81, ranges from 0 to 5
cut: is a factor (categorical data)
color: is a factor (categorical data)
clarity: is a factor (categorical data)
depth: mean 61.75, variation 36
table: mean 57.46, variation 52
price: mean 3933, variation 18497, highest price $18823
x: mean 5.731, variation 10.74
y: mean 5.735, variation 58.9
z: mean 3.539, variation 31.8

...
The distribution of E values is asymmetrical, bimodal distribution (with
two peaks) that is skewed left. This is not as easy to visualize without
the plot, as the “density” information is more easily understood when
put in visual form. Without the plot, however, we can still determine
the range of the data, as well as quantities such as its mean, median,

...
The price generally increases with carat, but the trend is not very
clean and there isn’t a single curve that represents the relationship.
There are outliers with carat values above 3 which stray away from the
general trend, where the price per carat is lower than it should be.
...
As seen before, the price generally increases with carat, but the trend
is not very clean and there isn’t a single curve that represents the
relationship.

The cut helps explain the variation in price, where ideal cut diamonds
(represented by yellow data points) tend to be more expensive and fair
cut diamonds (represented by blue data points) tend to be less
expensive. We can see that generally, the ideal cuts are worth more per
carat than the more “fair” cuts, which makes sense intuitively.

As in the previous plot, we saw that there were outliers with carat
values above 3 which stray away from the general trend. With the new
insights we obtained from this graph about the cut information, we can
confirm what we stated earlier: the price per carat is lower than it
should be. This makes sense with the new information that we have in our
disposal about the cuts, where the fair cuts with carat values close to
5 are cheaper than what the general trend would indicate.

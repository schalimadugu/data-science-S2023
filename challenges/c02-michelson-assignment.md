...
MeanVelocity difference of around 50 km/s), the majority of the images
had a Distinctness of 3.

- Why might your table differ from Michelson’s?
  - The table might differ due to rounding, so implementing `round()`
    would account for those value differences.
...
which has more outliers, such as with the data before June 09.
...
![](c02-michelson-assignment_files/figure-gfm/q5%20plot1-1.png)<!-- -->

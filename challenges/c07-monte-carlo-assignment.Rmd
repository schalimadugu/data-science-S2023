...
- Was your sample size $n$ large enough? Why do you say that?
  - I chose a sample size of 10000 points, which seemed large enough to approximate $\pi$, since I was able to obtain a value of 3.1488 which is relatively close to the true value of $\pi$, and the true value also fell within the confidence interval as described earlier.

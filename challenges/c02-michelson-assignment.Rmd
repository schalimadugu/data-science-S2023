...
- Make a quantitative comparison between Michelson's uncertainty and his error.
  - Michelson's uncertainty was plus or minus 51 km/s, but the true error was 151.142 km/s, which falls outside of his uncertainty.
...
**Observations**:
Similarities
- The general behavior and trend of the velocity data seems consistent, where they generally seem to be increasing and decreasing along the same time intervals. Plus, they both are centered around the same range.
...
Accoring to the first plot, there seems to be a very weak positive correlation between Temp and VelocityVacuum, with a Distinctness of 3 appearing generally more towards the higher temperatures after 70 degrees.
According to the second plot, the median VelocityVacuum value increased as the Distinctness increased. In addition, the Distinctness of 1 has one outlier that is less than the rest of the VelocityVacuum data, Distinctness of 2 has two outliers (one greater than and one less than the rest of the data), and Distinctness of 3 doesn't seem to have any outliers.
